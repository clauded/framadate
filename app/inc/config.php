...
// Application name
const NOMAPPLICATION = 'Inscriptions SET';

// Database administrator email
const ADRESSEMAILADMIN = 'info@sportentete.qc.ca';

// Email for automatic responses (you should set it to "no-reply")
const ADRESSEMAILREPONSEAUTO = 'ne-pas-repondre@sportentete.qc.ca';

// Database server name, leave empty to use a socket
const DB_CONNECTION_STRING = 'mysql:host=localhost;dbname=sporte2_framaset;port=3306;charset=utf8';
...
$config = [
    ...
    'default_poll_duration' => 6000,         // default values for the new poll duration (number of days).
