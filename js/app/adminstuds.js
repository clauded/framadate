$(document).ready(function() {
    ...
    $('#valuemax-form .btn-edit').on('click', function() {
        $('#valuemax-form p').hide();
        $('.js-valuemax').removeClass('hidden');
        $('.js-valuemax input').focus();
        return false;
    });

    $('#valuemax-form .btn-cancel').on('click', function() {
        $('#valuemax-form p').show();
        $('#valuemax-form .js-valuemax').addClass('hidden');
        $('#valuemax-form .btn-edit').focus();
        return false;
    });
    
    $('#value_max-form .btn-edit').on('click', function() {
        $('#value_max-form p').hide();
        $('.js-value_max').removeClass('hidden');
        $('.js-value_max input').focus();
        return false;
    });

    $('#value_max-form .btn-cancel').on('click', function() {
        $('#value_max-form p').show();
        $('#value_max-form .js-value_max').addClass('hidden');
        $('#value_max-form .btn-edit').focus();
        return false;
    });
