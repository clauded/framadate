...
{block name="header"}
    ...
    <link rel="stylesheet" href="{"css/set.css"|resource}">
{/block}
...
{block name=main}
        ...
        <div class="col-md-12 col-md-offset-0">
            <form name="formulaire" id="formulaire" method="POST" class="form-horizontal">
                <div class="alert alert-info">
                    <p>
                        {__('Step 1', 'You are in the poll creation section.')}&nbsp;{__('Step 1', 'Required fields cannot be left blank.')}
                    </p>
                </div>
                <br/>
    ...
    {/if}
                ...
                <div class="col-md-offset-1 col-md-1 hidden-xs">
                    <p class="lead">
    ...
    {/if}
                        ...
                        {* Poll identifier *}
                        <div class="form-group {$errors['customized_url']['class']}">
                            <label for="use_customized_url" class="col-sm-4 control-label">
    ...
    {/if}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="use_password" {if $poll_use_password}checked{/if} id="use_password">
    ...
    {/if}
                                ...
                                <div class="col-sm-offset-4 col-sm-8">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="results_publicly_visible" {if $poll_results_publicly_visible}checked{/if} id="results_publicly_visible"/>
    ...
    {if $use_smtp}
                        <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-8">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="receiveNewVotes" {if $poll_receiveNewVotes}checked{/if} id="receiveNewVotes">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-8">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="receiveNewComments" {if $poll_receiveNewComments}checked{/if} id="receiveNewComments">
    ...
    {/if}
                        <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-8">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="hidden" {if $poll_hidden}checked{/if} id="hidden">
