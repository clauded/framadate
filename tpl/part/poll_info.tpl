        ...
        <div class="row"> 
            ...
            {if $admin}
                <div class="form-group col-md-4">
                    ...
                    <div id="email-form">
                        <p>{$poll->admin_mail|html}<button class="btn btn-link btn-sm btn-edit" title="{__('PollInfo', 'Edit the email adress')}"><span class="glyphicon glyphicon-pencil"></span><span class="sr-only">{__('Generic', 'Edit')}</span></button></p>
        ...
        {if $admin}
            ...
            <div class="row">
                ...
                <div id="valuemax-form" class="form-group col-md-4">
                    <label class="control-label">{__('Step 1', 'ValueMax')}</label>
                    <p>{$poll->ValueMax|html} <button class="btn btn-link btn-sm btn-edit" title="{__('PollInfo', 'Edit value')}"><span class="glyphicon glyphicon-pencil"></span><span class="sr-only">{__('Generic', 'Edit')}</span></button></p>
                ...
                <div id="value_max-form" class="form-group col-md-4">
                    <label class="control-label">{__('Step 1', 'Value_Max')}</label>
                    <p>{$poll->value_max|html} <button class="btn btn-link btn-sm btn-edit" title="{__('PollInfo', 'Edit value')}"><span class="glyphicon glyphicon-pencil"></span><span class="sr-only">{__('Generic', 'Edit')}</span></button></p>
