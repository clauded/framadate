...
{/if}
    ...
    <link rel="stylesheet" href="{'css/bootstrap-datepicker3.min.css'|resource}">
...
{/if}
    <script src="{'js/jquery-3.7.1.min.js'|resource}"></script>
    <script src="{'js/bootstrap.min.js'|resource}"></script>
    <script src="{'js/bootstrap-datepicker.min.js'|resource}"></script>
{if 'en' != $locale}
